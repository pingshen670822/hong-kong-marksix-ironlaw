...
<section id="models" class="tab"><h2>520期時間序列走步回測</h2><div class="cards"><article><b>主號12碼平均命中</b><strong>{bt['main']['avg_hits']}</strong><small>隨機基準 1.4694</small></article><article><b>近60期平均命中</b><strong>{bt['main']['ensemble_recent_hits']['60']}</strong><small>發布門檻 ≥ 1.4694</small></article><article><b>近120期平均命中</b><strong>{bt['main']['ensemble_recent_hits']['120']}</strong><small>發布門檻 ≥ 1.4694</small></article></div><h2>全新三層滾動權重</h2><p>{e(bt['main']['weighting_strategy'])}</p><h2>逐模組錯誤檢討與滾動調整</h2>{table(['模型','上期命中','近30期','近120期','近360期','連續失誤','新權重','調整決策'],model_rows)}<h2>最強獨支運算鐵律</h2><p>所有模型依30／120／360期成績、校準誤差與連續失誤重新配權，再取校準機率唯一第1名；只使用開獎前已存在的歷史資料，嚴禁回填或用上期結果冒充預測。</p><h2>失敗回饋規則</h2><ul><li>短期30期占50%，120期占30%，360期占20%</li><li>校準誤差及連續零命中會額外扣權</li><li>單一模型權重上限22%</li><li>近60期與近120期未達隨機基準禁止發布</li><li>主號與特別號完全分開校準</li></ul></section>
